...
import (
	...
	"github.com/butlerdotdev/butler-bootstrap/internal/talos"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "5a321512.butlerlabs.dev",
	...
	workDir := "/tmp/butler-bootstrap"
	if err := os.MkdirAll(workDir, 0755); err != nil {
		setupLog.Error(err, "unable to create work directory")
		os.Exit(1)
	}

	// Initialize clients
	talosClient := talos.NewClient(workDir)
	addonInstaller := addons.NewInstaller(workDir)
